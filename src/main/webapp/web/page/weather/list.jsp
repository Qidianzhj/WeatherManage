...
<script type="text/html" id="toolbarDemo">
  <div class="layui-input-inline" style="width: 200px;">
    <input type="text" name="name" placeholder="请输入设备位置" class="layui-input" autocomplete="off"/>    
  </div>
...
var tableDemo=table.render({//指定id位置进行渲染
	...
	cols:[[
		...
		{field:'location',title:'位置',width:'15%'},
		{field:'weather',title:'天气',width:'16%'},
		{field:'tmp',title:'温度',width:'12%'},
		{field:'hum',title:'湿度',width:'12%'},
		{field:'wind',title:'污染指数',width:'20%'},
...
table.on('toolbar(test)', function(obj){//toolbar 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
 ...
 /*  case 'del':
  	...
  	case 'sel':
      table.reload('demo', {
        where: {location: $("input[name='name']").val()}//设定异步数据接口的额外参数    第一个name要与后台mapper元素对应
    ...
    case 'add':
    	layer.open({//打开子页面弹窗
    		type:2,
    		content:'/demo1/web/page/weather/add.jsp',
    		area:['500px','400px'],
    		maxmin:true,
  ...
  switch(layEvent){
    ...
    case 'upd':
     ...
     layer.open({//弹窗
    	 ...
    	 area:['500px','400px'],
    	 maxmin:true,
    	 content:'/demo1/web/page/weather/upd.jsp?num='+num,
    	 end:refresh
     });
    break;
  };
